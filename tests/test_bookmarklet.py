    ...
    def test_bookmarklet_preserves_szwego_api_url(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                self.assertIn("anchorDate?anchorClean(rawItems):filt(rawItems)", body)
                self.assertIn("const anchorClean=arr=>arr.filter(i=>!i.isTop&&!i.forwardTime)", body)
                ...
                self.assertIn("fullScan:!!anchorDate", body)
